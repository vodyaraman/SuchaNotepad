...
export const NoteManagerProvider = ({ children }) => {
    ...
    const [noteAdd, setNoteAdd] = useState({ important: true, timecode: '12:45' });

    console.log("Context Values:", { noteTitle, noteText, userName });

    return (
        <TextContext.Provider value={{ noteTitle, setNoteTitle, noteText, setNoteText, userName, setUserName, noteAdd, setNoteAdd }}>
            {children}
